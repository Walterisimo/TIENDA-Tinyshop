      ...
      <div className='nav__menu'>
        {
          open ? (
            <>
              <ul className='absolute w-full top-0 left-0 pt-5 mt-16 z-30 lg:relative lg:w-auto lg:pt-0 lg:mt-0 lg:flex'>
                ...
                <li className='cursor-pointer py-3 px-5 border-b border-solid border-slate-200 hover:bg-indigo-50 lg:py-5 lg:border-b-transparent' onClick={() => logout()}>Cerrar Sesión</li>
              </ul>
              { 
