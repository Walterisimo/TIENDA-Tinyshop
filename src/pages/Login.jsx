            ...
            <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
              ...
              <form className='space-y-4 md:space-y-6' onSubmit={handleForm}>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <a href='/reset-password' className='text-sm font-medium text-primary-600 hover:underline dark:text-primary-500'>¿Olvidaste tu contraseña?</a>
                </div>
                ...
                <p className='text-sm font-light text-gray-500 dark:text-gray-400'>
                  No tenés cuenta? <a href='/register' className='font-medium text-primary-600 hover:underline dark:text-primary-500'>Solicitá tu cuenta</a>
                </p>
              </form>
            </div>
          </div>
